...
// import { useState, useEffect } from "react";
// import { useRouter } from "next/navigation";
// import { ChevronLeft, Loader2, Save, LayoutDashboard, X, FileBadge, UploadCloud, Eye } from "lucide-react";
// import Image from "next/image";
...
//       certificateLayout: {
//         name: { x: Number(formData.certNameX), y: Number(formData.certNameY), size: 24 },
//         date: { x: Number(formData.certDateX), y: Number(formData.certDateY), size: 14 }
//       }
//     };
...
//             {/* ✅ PREVIEW BUTTON (Only shows if template exists) */}
//             {certificateUrl && (
//               <button 
//                 type="button"
//                 onClick={() => setShowPreview(true)}
//                 className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-blue-50 text-blue-700 text-xs font-bold hover:bg-blue-100 transition-colors border border-blue-100"
//               >
...
//                   Adjust where the User Name and Date will be printed. <br/>
